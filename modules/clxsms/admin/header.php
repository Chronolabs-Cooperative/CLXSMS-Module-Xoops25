 ...
 */
	...
	$GLOBALS['clxsmsImageIcon'] = XOOPS_URL .'/'. $GLOBALS['xoopsModule']->getInfo('icons16');
	$GLOBALS['clxsmsImageAdmin'] = XOOPS_URL .'/'. $GLOBALS['xoopsModule']->getInfo('icons32');
	...
	$GLOBALS['xoopsTpl']->assign('pathImageIcon', $GLOBALS['clxsmsImageIcon']);
